...
public class DatePicker extends DateTimePicker {
    ...
    public void setRangeStart(String rangeStart) {
        if (TextUtils.isEmpty(rangeStart)){
            return;
        }
        String[] date = rangeStart.split("-");
        super.setDateRangeStart(Integer.parseInt(date[0]), Integer.parseInt(date[1]), Integer.parseInt(date[2]));
    }
    /**
     * 设置范围：结束的年月日
     */
    public void setRangeEnd(String rangeEnd) {
        ...
        String[] date = rangeEnd.split("-");
        super.setDateRangeEnd(Integer.parseInt(date[0]), Integer.parseInt(date[1]), Integer.parseInt(date[2]));
    }
    ...
    public void setSelectedItem(String selectedItem) {
        ...
        super.setSelectedItem(Integer.parseInt(date[0]), Integer.parseInt(date[1]), Integer.parseInt(date[2]), 0, 0);
    }
