package com.hanergy.popwindowlib.wheelpicker.picker;
...
import com.hanergy.popwindowlib.wheelpicker.utils.DateUtils;
import com.hanergy.popwindowlib.wheelpicker.utils.LogUtils;
import com.hanergy.popwindowlib.wheelpicker.widget.WheelView;
...
public class DateTimePicker extends WheelPicker {
    ...
    private OnDateShortcutPickListener onDateShortcutPickListener;
    ...
    public void setOnDateShortcutPickListener(OnDateShortcutPickListener listener) {
        this.onDateShortcutPickListener = listener;
    }
    ...
    protected void onShortcutOptions(View view) {
        String lable = ((TextView) view).getText().toString();
        String nowDate = DateUtils.getNowDate();
        if (getContext().getString(R.string.today).equals(lable)){
            onDateShortcutPickListener.OnDateShortcutPicked(nowDate,nowDate,lable);
        }else if (getContext().getString(R.string.week).equals(lable)){
            onDateShortcutPickListener.OnDateShortcutPicked(DateUtils.getWeekStartDate(),nowDate,lable);
        }else if (getContext().getString(R.string.month).equals(lable)){
            onDateShortcutPickListener.OnDateShortcutPicked(DateUtils.getMonthStartDate(),nowDate,lable);
        }else if (getContext().getString(R.string.year).equals(lable)){
            onDateShortcutPickListener.OnDateShortcutPicked(DateUtils.getYearStartDate(),nowDate,lable);
        }
    }
    ...
    public interface OnDateShortcutPickListener {

        void OnDateShortcutPicked(String startDate, String nowDate, String title);
