...
import com.hanergy.popwindowlib.wheelpicker.popup.ConfirmPopup;
...
public abstract class WheelPicker extends ConfirmPopup<View> {
    ...
    protected int textColorFocusBlack = WheelView.TEXT_COLOR_FOCUS_BLACK;
    ...
    public void setTextColor(@ColorInt int textColorFocus, @ColorInt int textColorNormal) {
        ...
        this.textColorFocusBlack = textColorFocus;
   ...
   /* public void setTextColor(@ColorInt int textColor) {
    ...
    protected WheelView createWheelView() {
        ...
        wheelView.setTextColor(textColorNormal, textColorFocusBlack);
