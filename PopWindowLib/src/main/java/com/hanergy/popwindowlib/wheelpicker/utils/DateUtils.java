package com.hanergy.popwindowlib.wheelpicker.utils;
...
public class DateUtils extends android.text.format.DateUtils {
    ...
    public static boolean isSameDay(Date date) {
        ...
        return (nowCalendar.get(Calendar.ERA) == newCalendar.get(Calendar.ERA) && nowCalendar.get(Calendar.YEAR) == newCalendar.get(Calendar.YEAR) && nowCalendar.get(Calendar.DAY_OF_YEAR) == newCalendar.get(Calendar.DAY_OF_YEAR));
    }
    ...
    public static String getNextDate(Date date) {
        ...
        String datetime = formatDate(nextDate, "MM-dd");
        int c = datetime.compareTo("01-01");
        if (c==0){
